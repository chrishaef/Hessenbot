...
Options:
  --project-path PATH   Project root path (default: /opt/Hessenbot)
...
Examples:
  ...
  sudo bash etc/install_service.sh --project-path /opt/Hessenbot --user $USER
EOF
}
