...
BEHAVIOR: Dict[TooltipKey, str] = {
    ...
    ("location", "blitzWatchEnabled"): "True: Bot warnt Nodes mit frischem GPS bei Blitzen in der Nähe (Opt-out per !blitzwatch off).",
    ("location", "blitzWatchDefaultRadiusKm"): "Standard-Warnradius in km (Node kann 1–Max per !blitzwatch 5km setzen).",
    ("location", "blitzWatchMaxRadiusKm"): "Obergrenze für den per Node einstellbaren Radius.",
    ("location", "blitzWatchCooldownMin"): "Mindestabstand zwischen Warnungen (pro Node und für den Kanal).",
