...
BEHAVIOR: Dict[TooltipKey, str] = {
    ...
    ("general", "packetDedupHopWaitMs"): "Wartezeit (ms) auf UDP-Dublette mit besseren Hop-Daten, wenn MQTT zuerst kommt (0 = aus).",
    ...
    ("location", "locationRequestEnabled"): "True: Bei fehlendem Node-GPS Positionsanfrage per Mesh, dann Befehl automatisch nachholen.",
    ("location", "locationRequestTimeoutSec"): "Wartezeit in Sekunden auf GPS nach Positionsanfrage (danach Hinweis Ort/Koordinaten).",
    ("location", "locationRequestCooldownSec"): "Mindestabstand zwischen Positionsanfragen an dieselbe Node.",
    ...
    ("location", "blitzWatchPollMin"): "Wie oft Live-Blitzdaten abgefragt werden.",
    ("location", "blitzWatchChannel"): "Mesh-Kanalnummer für Kanalwarnungen; leer = general.defaultChannel.",
    ("location", "blitzRadiusKm"): "Umkreis in km um deinen Standort für Live-Blitz-Zählung.",
    ("location", "blitzortungUser"): "Optional: Login von blitzortung.org — sonst nur DMI-Daten.",
    ("location", "blitzortungPassword"): "Passwort zu blitzortungUser; nur lokal in config.ini.",
    ...
    ("messagingSettings", "cmdRateLimitEnabled"): "True: Zu viele Befehle pro Node werden abgewiesen (Airtime-Schutz).",
    ("messagingSettings", "cmdRateLimitMax"): "Max. Befehle pro Node im Zeitfenster (Default 3).",
    ("messagingSettings", "cmdRateLimitWindow"): "Zeitfenster in Sekunden für Befehls-Rate-Limit (Default 60).",
    ("messagingSettings", "cmdRateLimitNotifyOnce"): "True: Nur eine Hinweis-DM pro Fenster, danach still (kein weiteres Mesh-Paket).",
    ("messagingSettings", "cmdExpensiveCooldownSec"): "Mindestabstand in Sekunden für teure Befehle (!wx, !warning, …); 0 = aus.",
    ("messagingSettings", "cmdExpensiveCommands"): "Kommagetrennte Befehlswörter ohne ! für Extra-Cooldown.",
    # ── dataPersistence ──
